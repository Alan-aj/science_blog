...
function Update() {
    ...
    const dataSubmit = () => {
        ...
        // materialValue.forEach(v => { delete v._id });
        // stepValue.forEach(v => { delete v._id });
            ...
            <div className="flex items-center justify-center ">
                <div className="px-8 py-6 my-5 text-left bg-white shadow-lg w-2/4">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex items-center justify-center">
                            <button type="submit" onClick={dataSubmit} className="px-6 py-2 mt-4 text-white bg-cyan-700 rounded-lg hover:bg-cyan-900">Update</button>
                        </div>
                    </div>
                </div>
            </div>
