    ...
    return (
        <div className="bg-white shadow-md rounded-lg max-w-xs mb-5 hover:shadow-2xl m-3">
            ...
            <div className="p-5">
                ...
                <button onClick={() => navigate(`/${id}`)} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center">
                    Read more
                </button>
